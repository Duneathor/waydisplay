...
if(WAYDISPLAY_ENABLE_H265_SERVER_ENCODER OR WAYDISPLAY_ENABLE_H264_SERVER_ENCODER OR WAYDISPLAY_ENABLE_AV1_SERVER_ENCODER)
    ...
    if(FFMPEG_VIDEO_ENCODER_FOUND)
        ...
        if(WAYDISPLAY_ENABLE_AV1_SERVER_ENCODER)
            set(WAYDISPLAY_HAVE_AV1_SERVER_ENCODER TRUE)
        endif()
    else()
...
if(WAYDISPLAY_ENABLE_H265_CLIENT_DECODER OR WAYDISPLAY_ENABLE_H264_CLIENT_DECODER OR WAYDISPLAY_ENABLE_AV1_CLIENT_DECODER)
    ...
    if(FFMPEG_VIDEO_DECODER_FOUND)
        ...
        if(WAYDISPLAY_ENABLE_AV1_CLIENT_DECODER)
            set(WAYDISPLAY_HAVE_AV1_CLIENT_DECODER TRUE)
        endif()
...
# Runtime AV1 VAAPI decode capability is checked against libva's actual
# profile/entrypoint list, not just FFmpeg's codec-wide HW configuration.
if(WAYDISPLAY_HAVE_VAAPI_CLIENT_DECODER)
    pkg_check_modules(VAAPI_CLIENT QUIET IMPORTED_TARGET libva)
    if(NOT VAAPI_CLIENT_FOUND)
        message(FATAL_ERROR "VAAPI client decoder requires libva for per-device codec capability checks")
    endif()
endif()
...
if(WAYDISPLAY_REQUIRE_CODEC_TESTS)
    ...
    if(WAYDISPLAY_ENABLE_AV1_SERVER_ENCODER AND
       NOT WAYDISPLAY_HAVE_AV1_SERVER_ENCODER)
        list(APPEND _waydisplay_missing_codec_backends "AV1 server encoder")
    endif()
    if(WAYDISPLAY_ENABLE_AV1_CLIENT_DECODER AND
       NOT WAYDISPLAY_HAVE_AV1_CLIENT_DECODER)
        list(APPEND _waydisplay_missing_codec_backends "AV1 client decoder")
    endif()
...
function(waydisplay_find_wlroots)
    set(WAYDISPLAY_WLROOTS_MODULE "wlroots-0.20" PARENT_SCOPE)
    pkg_check_modules(WLROOTS_CANDIDATE QUIET IMPORTED_TARGET "wlroots-0.20>=0.20.0")
