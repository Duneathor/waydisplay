...
if(WAYDISPLAY_BUILD_TESTS)
    ...
    if(WAYDISPLAY_HAVE_H265_SERVER_ENCODER OR WAYDISPLAY_HAVE_H264_SERVER_ENCODER OR WAYDISPLAY_HAVE_AV1_SERVER_ENCODER)
        waydisplay_add_test(
            ...
            COMPILE_DEFINITIONS
                ...
                WAYDISPLAY_TEST_HAVE_AV1_ENCODER=$<BOOL:${WAYDISPLAY_HAVE_AV1_SERVER_ENCODER}>
            SKIP_RETURN_CODE 77
    ...
    if(WAYDISPLAY_HAVE_H265_CLIENT_DECODER OR WAYDISPLAY_HAVE_H264_CLIENT_DECODER OR WAYDISPLAY_HAVE_AV1_CLIENT_DECODER)
        waydisplay_add_test(
            ...
            COMPILE_DEFINITIONS
                ...
                WAYDISPLAY_TEST_HAVE_AV1_DECODER=$<BOOL:${WAYDISPLAY_HAVE_AV1_CLIENT_DECODER}>
                WAYDISPLAY_TEST_FIXTURE_DIR="${CMAKE_CURRENT_SOURCE_DIR}/tests/fixtures"
            SKIP_RETURN_CODE 77
    ...
    if(WAYDISPLAY_HAVE_VAAPI_CLIENT_DECODER AND
       (WAYDISPLAY_HAVE_H265_CLIENT_DECODER OR WAYDISPLAY_HAVE_H264_CLIENT_DECODER OR WAYDISPLAY_HAVE_AV1_CLIENT_DECODER))
        waydisplay_add_test(
    ...
    if((WAYDISPLAY_HAVE_H265_SERVER_ENCODER OR WAYDISPLAY_HAVE_H264_SERVER_ENCODER OR WAYDISPLAY_HAVE_AV1_SERVER_ENCODER) AND
       (WAYDISPLAY_HAVE_H265_CLIENT_DECODER OR WAYDISPLAY_HAVE_H264_CLIENT_DECODER OR WAYDISPLAY_HAVE_AV1_CLIENT_DECODER))
        waydisplay_add_test(
