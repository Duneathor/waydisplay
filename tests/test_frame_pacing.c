...
int main(void) {
    CHECK(wd_frame_rate_normalize_client_request(0) == WD_DEFAULT_SESSION_FPS);
    CHECK(wd_frame_rate_normalize_client_request(1) == 1);
    CHECK(wd_frame_rate_normalize_client_request(75) == 75);
    CHECK(wd_frame_rate_normalize_client_request(WD_MAX_SESSION_FPS) == WD_MAX_SESSION_FPS);
    CHECK(wd_frame_rate_normalize_client_request(UINT16_MAX) == WD_MAX_SESSION_FPS);
