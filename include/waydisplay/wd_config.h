...
#define WD_SERVER_IDLE_REFRESH_HZ               60u
...
#define WD_STREAM_ENCODER_QUEUE_WAVES                  4u
...
#define WD_STREAM_TILE_PREDICTOR_MIN_SAMPLES             4u
#define WD_STREAM_TILE_PREDICTOR_SKIP_MARGIN_PERCENT     125u
#define WD_STREAM_TILE_PREDICTOR_PROBE_INTERVAL            8u
#define WD_STREAM_TILE_PREDICTOR_EWMA_NEW_NUMERATOR        1u
#define WD_STREAM_TILE_PREDICTOR_EWMA_DENOMINATOR          4u
...
#define WD_CLIENT_AUDIO_VIDEO_PLAYING_HOLD_MAX_MS  2000u
...
#define WD_CLIENT_VIDEO_DECODE_INPUT_QUEUE_CAPACITY 4u
...
WD_CONFIG_STATIC_ASSERT(WD_SERVER_MIN_REFRESH_HZ > 0u && WD_SERVER_MIN_REFRESH_HZ <= WD_SERVER_IDLE_REFRESH_HZ &&
                            WD_SERVER_IDLE_REFRESH_HZ <= WD_SERVER_MAX_REFRESH_HZ,
