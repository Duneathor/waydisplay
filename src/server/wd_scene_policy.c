...
void wd_scene_policy_popup_constraint_box(int view_x, int view_y, int root_geometry_x, int root_geometry_y,
                                          int output_width, int output_height, struct wd_scene_policy_box* out_box) {
    if (!out_box)
    {
        return;
    }
